...
async def help_handler(_, event: Message):
    ...
    await event.reply_text(Config.ABOUT_HELP_TEXT.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
		[InlineKeyboardButton('My Updated Channel', url='https://t.me/maxx_movies')
	 ],[InlineKeyboardButton("Our Group", url="https://t.me/+LZw5yV07LPw2ZjU1"), 
...
async def button(bot, cmd: CallbackQuery):
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton('Our Channel', url='https://t.me/Maxx_hubb')
					],
					[
						InlineKeyboardButton("Updates 𝙲𝚑𝚊𝚗𝚗𝚊𝚕", url="https://t.me/Maxx_hubb")
					],
					[
			...
			reply_markup=InlineKeyboardMarkup(
				[
                                        [
					InlineKeyboardButton('Group', url='https://t.me/+x_SyirDsEUs4YmJl')
					],
					[
					InlineKeyboardButton("Updates 𝙲𝚑𝚊𝚗𝚗𝚊𝚕", url="https://t.me/Maxx_hubb")
					],
